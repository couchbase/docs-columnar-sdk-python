...
[source,python]
----
include::code-samples:example$async_query.py[tag=scope-query,indent=0]
----
--
====
...
[source,python]
----
include::code-samples:example$async_query.py[tag=cluster-query,indent=0]
----
--
====
...
[source,python]
----
include::code-samples:example$async_query.py[tag=query-positional-params,indent=0]
----
--
====
...
[source,python]
----
include::code-samples:example$async_query.py[tag=query-named-params,indent=0]
----
--
====
